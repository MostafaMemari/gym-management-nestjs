...
import { UserPatterns } from '../../../../common/enums/auth-user-service/user.events';
...
export class UserController {
  constructor(@Inject(Services.AUTH_USER) private readonly userServiceClient: ClientProxy) {}
